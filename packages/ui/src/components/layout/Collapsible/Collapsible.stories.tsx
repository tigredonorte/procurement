    ...
    <Collapsible {...args}>
      <Box sx={{ p: 2, bgcolor: 'background.paper', border: 1, borderColor: 'divider' }}>
        ...
        <Typography variant="body2" color="text.secondary">
          This content can be collapsed and expanded. The animation behavior depends on the variant
          prop selected.
        </Typography>
      </Box>
    </Collapsible>
...
const AllVariantsComponent = () => {
  ...
  return (
    <Stack spacing={3}>
      <Card>
        <CollapsibleTrigger onClick={() => toggleOpen('default')} expanded={openStates.default}>
        ...
        <Collapsible open={openStates.default} variant="default">
          <CollapsibleContent>
            <Typography variant="body2" color="text.secondary">
              The default variant uses Material-UI&apos;s built-in Collapse component with standard
              easing and timing. It provides reliable, accessible animation behavior.
            </Typography>
          </CollapsibleContent>
        </Collapsible>
      </Card>
      ...
      <Card>
        <CollapsibleTrigger onClick={() => toggleOpen('smooth')} expanded={openStates.smooth}>
        ...
        <Collapsible open={openStates.smooth} variant="smooth">
          <CollapsibleContent>
            <Typography variant="body2" color="text.secondary">
              The smooth variant provides a more refined animation with custom easing curves. It
              offers a more polished, professional feel with smoother transitions.
            </Typography>
          </CollapsibleContent>
        </Collapsible>
      </Card>
      ...
      <Card>
        <CollapsibleTrigger onClick={() => toggleOpen('spring')} expanded={openStates.spring}>
        ...
        <Collapsible open={openStates.spring} variant="spring">
          <CollapsibleContent>
            <Typography variant="body2" color="text.secondary">
              The spring variant uses elastic easing to create a bouncy, playful animation effect.
              Perfect for applications that want to add character and delight to their interactions.
            </Typography>
          </CollapsibleContent>
        </Collapsible>
      </Card>
...
const InteractiveExampleComponent = () => {
  ...
  return (
    <Stack spacing={3}>
      ...
      <Card>
        <CollapsibleTrigger onClick={() => setIsOpen(!isOpen)} expanded={isOpen}>
        ...
        <Collapsible open={isOpen} variant={variant} duration={duration}>
          <CollapsibleContent>
            ...
            <Typography variant="body2" color="text.secondary" mb={2}>
              Current settings: {variant} variant with {duration}ms duration. Try different
              combinations to see how the animation behavior changes.
            </Typography>
            <Box sx={{ p: 2, bgcolor: 'primary.50', borderRadius: 1 }}>
              <Typography variant="body2">
                This content area demonstrates how different variants and durations affect the
                collapse animation. The spring variant adds bounce, smooth provides refined easing,
                and default uses standard timing.
              </Typography>
            </Box>
          </CollapsibleContent>
        </Collapsible>
...
const SettingsPanelComponent = () => {
  ...
  const SettingsSection = ({
    ...
    <Card sx={{ mb: 1 }}>
      <CollapsibleTrigger onClick={() => toggleSection(id)} expanded={openSections[id]}>
...
const CallbackExampleComponent = () => {
  ...
  const handleToggle = (open: boolean) => {
    ...
    setLogs((prev) => [
      `${timestamp}: Collapsible ${open ? 'opened' : 'closed'}`,
      ...prev.slice(0, 4),
    ]);
  };
  ...
  return (
    <Stack spacing={3}>
      ...
      <Card>
        ...
        <Collapsible open={isOpen} variant="smooth" onToggle={handleToggle}>
          <CollapsibleContent>
            <Typography variant="body1" gutterBottom>
        ...
        <Collapsible open={true} variant="smooth">
          <CollapsibleContent>
            <Typography variant="body1" paragraph>
              This is medium-sized content that demonstrates how the Collapsible component handles
              different content lengths. It includes multiple paragraphs and more text.
            </Typography>
            <Typography variant="body2">
      ...
      <Card>
        ...
        <Collapsible open={true} variant="smooth">
          <CollapsibleContent>
            ...
            <Typography variant="body1" paragraph>
              This demonstrates the Collapsible component with substantial content. The component
              should handle large amounts of content gracefully without performance degradation or
              animation issues.
            </Typography>
            <Typography variant="body1" paragraph>
            ...
            <List>
              <ListItem>
                <ListItemText primary="Feature 1" secondary="Description of feature" />
              </ListItem>
              <ListItem>
                <ListItemText primary="Feature 2" secondary="Description of feature" />
              </ListItem>
              <ListItem>
                <ListItemText primary="Feature 3" secondary="Description of feature" />
              </ListItem>
            </List>
            <Typography variant="body1" paragraph>
              More content to demonstrate the component's ability to handle large content areas
              while maintaining smooth animations and good performance.
            </Typography>
          </CollapsibleContent>
        </Collapsible>
      </Card>
