...
export const AllVariants: Story = {
  render: () => {
    ...
    const DrawerButton = ({ variant, label }: { variant: keyof typeof openDrawers; label: string }) => (
      <Button 
        variant="outlined" 
        onClick={() => toggleDrawer(variant)}
        sx={{ m: 1 }}
      >
        {label}
      </Button>
    ...
    return (
      <Box sx={{ height: '100vh', position: 'relative' }}>
        ...
        <Drawer 
          ...
          variant="left"
        >
          <DrawerHeader onClose={() => toggleDrawer('left')}>
            Left Navigation
          </DrawerHeader>
          <DrawerContent>
            <List>
        ...
        <Drawer 
          ...
          variant="right"
        >
          <DrawerHeader onClose={() => toggleDrawer('right')}>
            Right Panel
          </DrawerHeader>
          <DrawerContent>
            <List>
        ...
        <Drawer 
          ...
          height={200}
        >
          <DrawerHeader onClose={() => toggleDrawer('top')}>
            Top Panel
          </DrawerHeader>
          <DrawerContent>
        ...
        <Drawer 
          ...
          height={200}
        >
          <DrawerHeader onClose={() => toggleDrawer('bottom')}>
            Bottom Panel
          </DrawerHeader>
          <DrawerContent>
            <Typography variant="body2">
        ...
        <Box sx={{ p: 4, pt: 10 }}>
          ...
          <Typography variant="body1">
            Click the buttons above to open different drawer variants. 
            Each variant demonstrates different positioning and styling options.
          </Typography>
        </Box>
      </Box>
    );
      ...
      <Box sx={{ display: 'flex', height: '100vh' }}>
        ...
        <Box component="main" sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Box sx={{ p: 3, flex: 1 }}>
            ...
            <Typography variant="body1">
              This is the content for the {navItems.find(item => item.id === selectedItem)?.label.toLowerCase()} section.
              The drawer can be toggled using the menu button in the header.
            </Typography>
          </Box>
        </Box>
      </Box>
