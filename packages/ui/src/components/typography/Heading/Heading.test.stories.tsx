...
const meta: Meta<typeof Heading> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Comprehensive test stories for the Heading component covering interaction, accessibility, visual states, performance, and edge cases.',
      },
    },
  },
...
const FocusManagementComponent = () => {
  ...
  return (
    <Stack spacing={2} data-testid="focus-management-container">
      <Box>
        <button onClick={() => focusHeading('h1')} data-testid="focus-h1-btn">Focus H1</button>
        <button onClick={() => focusHeading('h2')} data-testid="focus-h2-btn">Focus H2</button>
        <button onClick={() => focusHeading('h3')} data-testid="focus-h3-btn">Focus H3</button>
      </Box>
    ...
    <Stack spacing={1} data-testid="performance-container">
      ...
      {Array.from({ length: 50 }, (_, index) => (
        <Heading 
          ...
          color={(['primary', 'secondary', 'success', 'warning', 'danger', 'neutral'] as const)[index % 6]}
...
export const AnchorLinks: Story = {
  ...
  render: () => (
    <Stack spacing={4} data-testid="anchor-links-container">
      ...
      <Box sx={{ mt: 4 }}>
        <a href="#main-title" data-testid="main-link">Go to Main Title</a><br />
        <a href="#section-1" data-testid="section-link">Go to Section 1</a><br />
        <a href="#subsection-1-1" data-testid="subsection-link">Go to Subsection 1.1</a>
      </Box>
    </Stack>
  ),
  play: async ({ canvasElement }) => {
...
export const ResponsiveDesign: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(responsiveH1).toHaveStyle('font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif');
  },
};
  ...
  render: () => (
    <Stack spacing={3} data-testid="visual-states-container">
      <Stack spacing={1}>
        ...
        <Heading level="h1" data-testid="level-h1">H1 Heading</Heading>
        <Heading level="h2" data-testid="level-h2">H2 Heading</Heading>
        <Heading level="h3" data-testid="level-h3">H3 Heading</Heading>
        <Heading level="h4" data-testid="level-h4">H4 Heading</Heading>
        <Heading level="h5" data-testid="level-h5">H5 Heading</Heading>
        <Heading level="h6" data-testid="level-h6">H6 Heading</Heading>
        <Heading level="display" data-testid="level-display">Display Heading</Heading>
      </Stack>
      
      <Stack spacing={1}>
        <div>Color Variations:</div>
        <Heading level="h3" color="primary" data-testid="color-primary">Primary Color</Heading>
        <Heading level="h3" color="secondary" data-testid="color-secondary">Secondary Color</Heading>
        <Heading level="h3" color="success" data-testid="color-success">Success Color</Heading>
        <Heading level="h3" color="warning" data-testid="color-warning">Warning Color</Heading>
        <Heading level="h3" color="danger" data-testid="color-danger">Danger Color</Heading>
        <Heading level="h3" color="neutral" data-testid="color-neutral">Neutral Color</Heading>
      </Stack>
      
      <Stack spacing={1}>
        <div>Weight Variations:</div>
        <Heading level="h3" weight="light" data-testid="weight-light">Light Weight</Heading>
        <Heading level="h3" weight="normal" data-testid="weight-normal">Normal Weight</Heading>
        <Heading level="h3" weight="medium" data-testid="weight-medium">Medium Weight</Heading>
        <Heading level="h3" weight="semibold" data-testid="weight-semibold">Semibold Weight</Heading>
        <Heading level="h3" weight="bold" data-testid="weight-bold">Bold Weight</Heading>
      </Stack>
      
      <Stack spacing={1}>
        <div>Gradient Effect:</div>
        <Heading level="h2" gradient={true} data-testid="gradient-heading">Gradient Heading</Heading>
        <Heading level="h2" gradient={false} data-testid="non-gradient-heading">Non-Gradient Heading</Heading>
      </Stack>
    </Stack>
  ),
  play: async ({ canvasElement }) => {
...
export const EdgeCases: Story = {
  ...
  render: () => (
    <Stack spacing={2} data-testid="edge-cases-container">
      <Heading level="h1" data-testid="empty-content">
      </Heading>
      
      <Heading level="h2" data-testid="very-long-content">
        This is a very long heading that should wrap properly and maintain readability even when the content extends beyond the normal width of the container and continues to multiple lines to test text overflow and wrapping behavior
      </Heading>
...
export const Integration: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(() => {
      ...
      expect(canvas.getByTestId('tab-subheading')).toHaveTextContent('This is the content for tab 2');
    });
