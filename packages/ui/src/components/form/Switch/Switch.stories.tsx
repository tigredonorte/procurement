...
const [states, setStates] = useState({
    ...
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        ...
        <Box>
          <Typography variant="h6" gutterBottom>iOS Style</Typography>
          <Switch
            variant="ios"
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Android Style</Typography>
          <Switch
            variant="android"
        ...
        <Box>
          <Typography variant="h6" gutterBottom>With Text Labels</Typography>
          <Switch
            variant="label"
...
const [states, setStates] = useState({
    ...
    return (
      <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 4 }}>
        <Box>
          <Typography variant="h6" gutterBottom>Start Position</Typography>
          <Switch
            label="Switch at end"
        ...
        <Box>
          <Typography variant="h6" gutterBottom>End Position</Typography>
          <Switch
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Top Position</Typography>
          <Switch
            label="Switch below"
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Bottom Position</Typography>
          <Switch
            label="Switch above"
...
const [states, setStates] = useState({
    ...
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
        <Box>
          <Typography variant="h6" gutterBottom>Custom Width & Height</Typography>
          <Switch
            label="Wide switch"
            trackWidth={80}
            trackHeight={30}
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Tall Switch</Typography>
          <Switch
            label="Tall switch"
            trackWidth={60}
            trackHeight={40}
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Mini Switch</Typography>
          <Switch
            label="Mini switch"
            trackWidth={30}
            trackHeight={16}
