  ...
  render: () => {
    ...
    return (
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        <Box>
          <Typography variant="h6" gutterBottom>Single Selection</Typography>
        ...
        <Box>
          <Typography variant="h6" gutterBottom>Exclusive Selection</Typography>
          <Typography variant="body2" color="text.secondary" gutterBottom>
...
export const IconOnly: Story = {
  render: () => {
    ...
    return (
      <Box>
        <Typography variant="h6" gutterBottom>Media Controls</Typography>
        <Typography variant="body2" color="text.secondary" gutterBottom>
...
export const WithLabels: Story = {
  render: () => {
    ...
    return (
      <Box>
        <Typography variant="h6" gutterBottom>List Formatting</Typography>
        <Typography variant="body2" color="text.secondary" gutterBottom>
...
export const WithDisabledOptions: Story = {
  render: () => {
    ...
    return (
      <Box>
        <Typography variant="h6" gutterBottom>With Disabled Options</Typography>
        <Typography variant="body2" color="text.secondary" gutterBottom>
