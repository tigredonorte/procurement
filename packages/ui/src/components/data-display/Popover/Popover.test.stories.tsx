...
export const BasicInteraction: Story = {
  render: () => (
    <div>
      ...
      <div aria-label="Status of the test run" style={{ display: 'none' }}>
        PASS
      </div>
    </div>
  ),
    ...
    <div>
      <PopoverTestWrapper>
        <div style={{ padding: 16 }}>
          ...
          <List dense>
            <ListItem component="button" data-testid="menu-item-profile" onClick={() => {}}>
              <ListItemText primary="Profile Settings" />
            </ListItem>
            <ListItem component="button" data-testid="menu-item-account" onClick={() => {}}>
              <ListItemText primary="Account Security" />
            </ListItem>
            <ListItem component="button" data-testid="menu-item-notifications" onClick={() => {}}>
    ...
    <PopoverTestWrapper>
      <div role="dialog" aria-label="User menu popover" style={{ padding: 16 }}>
        ...
        <List dense aria-labelledby="popover-title">
          <ListItem component="button" role="menuitem" data-testid="accessible-item-1">
            <ListItemText primary="Accessible Item 1" />
          </ListItem>
          <ListItem component="button" role="menuitem" data-testid="accessible-item-2">
