...
export const EdgeCases: Story = {
    ...
    const TestComponent = () => {
      ...
      return (
        <Box data-testid="edge-cases-container">
          <div>
            <button onClick={() => setTestCase('empty')} data-testid="test-empty">Empty</button>
            <button onClick={() => setTestCase('single')} data-testid="test-single">Single</button>
            <button onClick={() => setTestCase('invalid')} data-testid="test-invalid">Invalid</button>
          </div>
          <div data-testid="current-case">{testCase}</div>
          <Stepper
            steps={getStepsForCase()}
  ...
  play: async ({ canvasElement }) => {
    ...
    const stepButtons = canvas.getAllByRole('button').filter(btn => 
