...
const meta: Meta<typeof Tooltip> = {
  title: 'Data Display/Tooltip/Tests',
  component: Tooltip,
  parameters: {
    layout: 'centered',
...
export const ScreenReaderTest: Story = {
  ...
  render: () => (
    <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
      <Tooltip 
        title="This tooltip provides additional context"
        variant="default"
      >
        <Button 
          data-testid="aria-component"
          aria-label="Action button with tooltip"
        >
          Action
        </Button>
      </Tooltip>
    ...
    <Box sx={{ p: 4, display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'center' }}>
      <Stack direction="row" spacing={2}>
        <Tooltip title="Default theme" variant="default">
          <Button variant="outlined" data-testid="default-theme">Default</Button>
        </Tooltip>
        
        <Tooltip title="Light theme" variant="light">
          <Button variant="outlined" data-testid="light-theme">Light</Button>
        </Tooltip>
        
        <Tooltip title="Dark theme" variant="dark">
          <Button variant="outlined" data-testid="dark-theme">Dark</Button>
        </Tooltip>
        
        <Tooltip title="Glass theme" variant="glass">
          <Button variant="outlined" data-testid="glass-theme">Glass</Button>
        </Tooltip>
      </Stack>
      
      <Stack direction="row" spacing={2}>
        <Tooltip title="Glow effect" variant="default" glow>
          <Button variant="contained" color="primary" data-testid="glow-effect">Glow</Button>
        </Tooltip>
        
        <Tooltip title="Pulse animation" variant="light" pulse>
          <Button variant="contained" color="secondary" data-testid="pulse-effect">Pulse</Button>
        </Tooltip>
        
        <Tooltip title="Combined effects" variant="glass" glow pulse>
          <Button variant="contained" color="success" data-testid="combined-effects">Combined</Button>
        </Tooltip>
      </Stack>
    </Box>
  ),
