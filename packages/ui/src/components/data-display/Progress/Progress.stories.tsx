...
export const Variants: Story = {
  render: () => (
    <Stack spacing={4}>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Linear</Typography>
        <Progress variant="linear" value={60} showLabel />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Circular</Typography>
        <Progress variant="circular" value={75} showLabel />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Segmented</Typography>
        <Progress variant="segmented" value={45} segments={8} showLabel />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Gradient</Typography>
  ...
  render: () => (
    <Stack direction="row" spacing={3} alignItems="center">
      ...
      <Box textAlign="center">
        ...
        <Typography variant="caption" display="block" sx={{ mt: 1 }}>Custom</Typography>
      </Box>
    </Stack>
  ),
};
...
export const SegmentedVariations: Story = {
  render: () => (
    <Stack spacing={3}>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>5 Segments</Typography>
        <Progress variant="segmented" segments={5} value={60} showLabel />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>10 Segments</Typography>
        <Progress variant="segmented" segments={10} value={70} showLabel />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>20 Segments</Typography>
...
const [progress, setProgress] = React.useState(0);
    ...
    return (
      <Box sx={{ width: 400 }}>
        <Typography variant="h6" sx={{ mb: 2 }}>File Upload Progress</Typography>
        <Progress 
          variant="gradient"
          value={progress}
          showLabel
        ...
        <Box sx={{ mt: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Typography variant="body2" color="text.secondary">
            {isUploading ? 'Uploading document.pdf...' : progress === 100 ? 'Upload complete!' : 'Ready to upload'}
          </Typography>
          <Button 
            variant="contained" 
            size="small" 
    ...
    <Stack spacing={3} sx={{ width: 400 }}>
      ...
      <Box>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
          ...
          <Typography variant="body2" color="text.secondary">Expert</Typography>
        </Box>
...
export const Dashboard: Story = {
  render: () => (
    <Stack direction="row" spacing={4}>
      ...
      <Box textAlign="center">
        <Typography variant="h6" sx={{ mb: 2 }}>Memory</Typography>
        <Progress 
          variant="circular" 
          value={45} 
          showLabel 
      ...
      <Box textAlign="center">
        <Typography variant="h6" sx={{ mb: 2 }}>Storage</Typography>
        <Progress 
          variant="circular" 
          value={89} 
          showLabel 
...
export const LoadingStates: Story = {
  render: () => (
    <Stack spacing={4}>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Linear Indeterminate</Typography>
        <Progress variant="linear" />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>Circular Indeterminate</Typography>
        <Progress variant="circular" />
      </Box>
      <Box>
        <Typography variant="subtitle2" sx={{ mb: 1 }}>With Effects</Typography>
